...
#ifndef soapmywsService_H
#define soapmywsService_H
#include "soapH.h"

    class SOAP_CMAC mywsService {
      public:
        ...
        virtual void mywsService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual mywsService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        mywsService& operator=(const mywsService&);
        ...
        virtual int getSensorData(ns__sensorData *sensorReading) SOAP_PURE_VIRTUAL;
    };
#endif
