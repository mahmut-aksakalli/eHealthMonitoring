	...
	int diastolic)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->ns__sensorData::temperature = temperature;
		_p->ns__sensorData::ecg = ecg;
		_p->ns__sensorData::pulse = pulse;
		_p->ns__sensorData::systolic = systolic;
		_p->ns__sensorData::diastolic = diastolic;
	}
	return _p;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__sensorData(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (::soap_read_ns__sensorData(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_ns__getSensorData_DEFINED
#define SOAP_TYPE_ns__getSensorData_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__getSensorData(struct soap*, struct ns__getSensorData *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getSensorData(struct soap*, const struct ns__getSensorData *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__getSensorData(struct soap*, const char*, int, const struct ns__getSensorData *, const char*);
SOAP_FMAC3 struct ns__getSensorData * SOAP_FMAC4 soap_in_ns__getSensorData(struct soap*, const char*, struct ns__getSensorData *, const char*);
SOAP_FMAC1 struct ns__getSensorData * SOAP_FMAC2 soap_instantiate_ns__getSensorData(struct soap*, int, const char*, const char*, size_t*);

inline struct ns__getSensorData * soap_new_ns__getSensorData(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns__getSensorData(soap, n, NULL, NULL, NULL);
}

inline struct ns__getSensorData * soap_new_req_ns__getSensorData(
	struct soap *soap)
{
	struct ns__getSensorData *_p = ::soap_new_ns__getSensorData(soap);
	if (_p)
	{	::soap_default_ns__getSensorData(soap, _p);
	}
	return _p;
}

inline struct ns__getSensorData * soap_new_set_ns__getSensorData(
	struct soap *soap)
{
	struct ns__getSensorData *_p = ::soap_new_ns__getSensorData(soap);
	if (_p)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__getSensorData(struct soap*, const struct ns__getSensorData *, const char*, const char*);

inline int soap_write_ns__getSensorData(struct soap *soap, struct ns__getSensorData const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_ns__getSensorData(soap, p), 0) || ::soap_put_ns__getSensorData(soap, p, "ns:getSensorData", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns__getSensorData(struct soap *soap, const char *URL, struct ns__getSensorData const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__getSensorData(soap, p), 0) || ::soap_put_ns__getSensorData(soap, p, "ns:getSensorData", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ns__getSensorData(struct soap *soap, const char *URL, struct ns__getSensorData const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__getSensorData(soap, p), 0) || ::soap_put_ns__getSensorData(soap, p, "ns:getSensorData", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct ns__getSensorData * SOAP_FMAC4 soap_get_ns__getSensorData(struct soap*, struct ns__getSensorData *, const char*, const char*);

inline int soap_read_ns__getSensorData(struct soap *soap, struct ns__getSensorData *p)
{
	if (p)
	{	::soap_default_ns__getSensorData(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_ns__getSensorData(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns__getSensorData(struct soap *soap, const char *URL, struct ns__getSensorData *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__getSensorData(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_ns__getSensorData(struct soap *soap, struct ns__getSensorData *p)
{
	if (::soap_read_ns__getSensorData(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
